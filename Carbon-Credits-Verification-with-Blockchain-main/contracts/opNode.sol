...
import {AuthorizedReceiver} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/operatorforwarder/AuthorizedReceiver.sol";
import {LinkTokenReceiver} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/operatorforwarder/LinkTokenReceiver.sol";
import {ConfirmedOwner} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/shared/access/ConfirmedOwner.sol";
import {LinkTokenInterface} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/shared/interfaces/LinkTokenInterface.sol";
import {IAuthorizedReceiver} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/operatorforwarder/interfaces/IAuthorizedReceiver.sol";
import {OperatorInterface} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/interfaces/OperatorInterface.sol";
import {IOwnable} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/shared/interfaces/IOwnable.sol";
import {IWithdrawal} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/operatorforwarder/interfaces/IWithdrawal.sol";
import {OracleInterface} from ".deps/npm/@chainlink/contracts@1.3.0/src/v0.8/interfaces/OracleInterface.sol";
...
contract opNode is AuthorizedReceiver, ConfirmedOwner, LinkTokenReceiver, OperatorInterface, IWithdrawal {
  struct Commitment {
    bytes31 paramsHash;
    uint8 dataVersion;
  }
  ...
  constructor(address owner) ConfirmedOwner(owner) {
    i_linkToken = LinkTokenInterface(0x779877A7B0D9E8603169DdbD7836e478b4624789); // external but already deployed and unalterable
  }
